...
export default class ModalNC  extends React.Component {

  render() {
    return (
      <div>
        <div id="repModal" className="modal fade" tabIndex="-1" role="dialog" aria-labelledby="Ms Natalie Colbert modal bio">
                ...
                <div className="row">
                  <div className="col-xs-5 col-md-3 col-sm-3">
                    <div className="thumbnail">
                      <img src={Natalie_Colbert} alt="Ms Natalie Colbert"/>
                    </div>
                    </div>
