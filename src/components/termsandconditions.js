                ...
                <div id="content" className="body-content container no-border" tabIndex="-1" autoFocus>
                    ...
                    <ol className="breadcrumb hidden-print">
                      ...
                      <div className="col-md-10" id="mainCol">
                        ...
                        <li>in the event that an applicant or nominee is involved in any conduct or activity (including of a personal or business nature) that is illegal, fraudulent
                            or causes harm to the Australian Government, or the judging panel/s are of the view that there is the potential to cause harm or reputational damage to
                        ...
                        <li>in submitting the application, the applicant warrants that they own the material included in their application (including any supporting evidence) and provide
