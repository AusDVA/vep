        ...
        return (
          ...
          <div ref="mainContent" id="content" className="body-content container no-border" tabIndex="-1" autoFocus>
            <div className="row">
              ...
              <h1>Disclaimer</h1>
                <p>The information on this website is presented by the Department of Veterans’ Affairs (DVA) for the purpose of informing the public.</p>
               ...
               <p><Link to="/contact#top">Contact DVA</Link> if you have any concerns about the information contained on this website. </p>
           </div>
            </div>
             </div>
             </section>
