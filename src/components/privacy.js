                    ...
                    <section id="section-nobreak">
                          <h2 id="cookies">Cookies</h2>
                            ...
                            <p>This website may use session cookies during a search query of the website.  No other cookies are employed on the website except for those
                               associated with the search engine and analytics. Website statistics for this website are generated from the web logs as outlined above under <Link to="#site-visit-data">Site visit data</Link>.</p>
                            <p>Once you have closed your browser, the session cookie set by this website is destroyed and DVA does not maintain any personal information
                               that might identify you should you visit this website at a later date.</p>
