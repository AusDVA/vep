          ...
          <div className="body-content container">
            <div className="row">
              ...
              <li className="list-unstyled-header"> Contents </li>
                  <li>
                    <a href="#sec0">Benefits of employing veterans</a>
                  </li>
                  <li>
                    <a href="#sec1">Industry Advisory Committee on Veterans’ Employment</a>
                  </li>
                  <li>
                    <a href="#sec2">Ex-service Organisation Industry Partnership Register</a>
                  </li>
                  <li>
                    <a href="#sec3">Department of Employment initiatives</a>
                  </li>
                  <li>
                    <a href="#sec4">Prime Minister’s Veterans’ Employment Annual Awards</a>
                  </li>
                  <li>
                    <a href="#sec5">Resources for employers</a>
                  </li>
                  <li>
                    <a href="#sec">Resources-general</a>
                  </li>
                </ul>
                ...
                <h2 id="sec0">Benefits of employing veterans</h2>
                ...
                <h2 id="sec1">Industry Advisory Committee on Veterans’ Employment </h2>
                 <p>The Industry Advisory Committee on Veterans’ Employment has been established under the Program to develop and provide advice on practical measures
                   to embed veterans’ employment strategies into the recruitment practices of Australian businesses.
                 </p>

                 <h2 id="sec2">Ex-service Organisation Industry Partnership Register</h2>
                 ...
                 <p>This Register will enable ex-service organisations to register their interest in partnering with industry on projects to promote the employment of veterans.
                  ...
                  <h2 id="sec3">Department of Employment initiatives</h2>
                  ...
                  <h2 id="sec4">Prime Minister’s Veterans’ Employment Annual Awards</h2>
                 ...
                 <h2 id="sec5">Resources for employers</h2>
