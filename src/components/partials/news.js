    ...
    return (
    	...
    	<div className="container section-nobreak no-float-print">
            ...
            <section>
                  ...
                  <ToggleDisplay show={this.state.showReadMore1}>
                  <a className="hidden-print" href="#news1" onClick={ (e) => this.handleClickNews1(e) }>Read more
                  <span className="sr-only">Less about the Industry Advisory Committee's inaugural meeting"</span></a>
                  </ToggleDisplay>

                  <ToggleDisplay show={this.state.showNews1}>
                  <p id="news1">At the meeting, the Committee focused on establishing a number of priority areas of focus. These areas include the availability of data on the employment profile of veterans, improving the transition process from the ADF, translating skills and raising awareness of the value that former members of the ADF offer to Australian businesses.</p>
                  ...
                  <a className="hidden-print" href="#" onClick={ (e) => this.handleClickNews1(e) }>Read less
                  <span className="sr-only">Less about the Industry Advisory Committee's inaugural meeting"</span></a>
                </ToggleDisplay>
    						</div>
    					</div>
    			...
    			<div className="col-sm-12 col-md-6 col-md-offset-1">
                  ...
                  <ToggleDisplay show={this.state.showReadMore2}>
                  <a href="#news2" className="hidden-print" onClick={ (e) => this.handleClickNews2(e) }>Read more
                  <span className="sr-only">More about jobactive</span>
                </a>
                </ToggleDisplay>

                    <ToggleDisplay show={this.state.showNews2}>
                  <p id="news2">The <a target="_blank" href="https://www.jobactive.gov.au/">jobactive website <span className="sr-only">(this link will open in a new tab)</span> </a> now 
                  ...
                  <a href="#" className="hidden-print" onClick={ (e) => this.handleClickNews2(e) }>Read less
                  <span className="sr-only">Less about jobactive</span> </a>
                </ToggleDisplay>              
    						</div>
    					</div>
    				</section>
