    ...
    return (
    	...
    	<div className="container section-nobreak no-float-print">
            ...
            <section>
                  ...
                  <span className="sr-only">{this.state.showNews1 ? "Less about the Industry Advisory Committee's inaugural meeting" : "More about the Industry Advisory Committee's inaugural meeting"}</span></a>
    						</div>
    					</div>
              </section>
