                ...
                <div ref="mainContent" id="content" className="body-content container no-border" tabIndex="-1" autoFocus>
                    ...
                    <ol className="breadcrumb hidden-print">
                      ...
                      <div className="col-md-10" id="mainCol">
                        ...
                        <h2>Can I self-nominate my organisation as well as nominate another organisation in the same award category?</h2>
                        <p>You can self-nominate your organisation and nominate another organisation in the same award category providing both organisations meet the relevant eligibility criteria.</p>

                        <h2>Can an individual self-nominate?</h2>
                        <p>Individuals cannot self-nominate in any of the award categories.  The only category where nominees are individuals requires that the nomination be submitted by their employer.</p>

                        <h2>If multiple organisations are responsible for co-designing or developing a policy, strategy or initiative that supports and/or creates employment for veterans or military spouses, who submits the nomination?</h2>
                        ...
                        <ul>
                         <li>Word or PDF documents containing statistical and other relevant information</li>
                        ...
                        <p>You can come back and add or change anything in your nomination prior to the nomination closing date of 22 December 2017.
                           This can be done by accessing your nomination at <a target="_blank" href="https://veteransemployment.awardsplatform.com/">veteransemployment.awardsplatform.com.<span className="sr-only">(this link will open in a new tab)</span></a> </p>
                        ...
                        <p>If you have any questions you can email the Department of Veterans’ Affairs at <a href="mailto:veteransemployment@dva.gov.au">veteransemployment@dva.gov.au.</a></p>
